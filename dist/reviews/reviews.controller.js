...
let ReviewsController = class ReviewsController {
    ...
    getAllReviews(page, limit) {
        return this.reviewsService.getAllReviews(page ? parseInt(page) : 1, limit ? parseInt(limit) : 20);
    }
    getProductReviews(productId, page, limit) {
        return this.reviewsService.getProductReviews(productId, page ? parseInt(page) : 1, limit ? parseInt(limit) : 10);
    }
    createReview(req, body) {
        const userId = req.user.id || req.user.sub;
        return this.reviewsService.createReview(userId, body);
    }
    addAdminReply(id, body) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ReviewsController.prototype, "addAdminReply", null);
